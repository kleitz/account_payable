<div class="col-xs-12">
    <div class="box box-primary">
        <form class="form-inline" role="form" name="filterdata" method="post" action="<?php echo site_url('expensereport/go/'.$pagecode) ?>">
            ...
            <div class="box-header with-border">
                ...
                <div class="input-group">
                    <div class="btn-group">
                        <a href="<?php echo site_url('expensereport/go/'.$pagecode.'/1/') ?>" class="btn btn-default">Today</a>
                        <a href="<?php echo site_url('expensereport/go/'.$pagecode.'/2/') ?>" class="btn btn-default">Yesterday</a>
                        <a href="<?php echo site_url('expensereport/go/'.$pagecode.'/3/') ?>" class="btn btn-default">This Week</a>
                        <a href="<?php echo site_url('expensereport/go/'.$pagecode.'/4/') ?>" class="btn btn-default">This Month</a>
                        <a href="<?php echo site_url('expensereport/go/'.$pagecode.'/5/') ?>" class="btn btn-default">Last Month</a>
                        <a href="<?php echo site_url('expensereport/go/'.$pagecode.'/6/') ?>" class="btn btn-default">Up to Today</a>
                    </div>
                </div>
            </div> 
        </form>
            ...
            <table id="datatable2" class="table table-striped table-bordered">
                ...
                if (sizeof($array)!=0){
                    ...
                    for($i=0; $i<sizeof($array); $i++){
                        echo '<tr>';
                        echo '<td>'.$no.'</td>';
                        echo '<td><div style="font-size:12px">'. $array[$i][0] .'</div></td>';
                        $k = 0;
                        foreach ($branch as $b) {
