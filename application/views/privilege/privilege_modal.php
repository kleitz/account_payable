<script type="text/javascript">
    ...
    function edit_data(id)
    {
        ...
        $.ajax({
            url: "<?php echo site_url('privilege/ajax_edit/') ?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function (data)
            {
                $('[name="priv_group_id"]').val(data.priv_group_id);
                $('[name="priv_group_name"]').val(data.priv_group_name);
    ...
    function save()
    {
        ...
        if (save_method == 'add')
        {
            url = "<?php echo site_url('privilege/group_add') ?>";
        }
        else
        {
            url = "<?php echo site_url('privilege/group_update') ?>";
        }
    ...
    function delete_data(id)
    {
        if (confirm('Are you sure delete this data?'))
        {
            ...
            $.ajax({
                url: "<?php echo site_url('privilege/group_delete') ?>/" + id,
                type: "POST",
                dataType: "JSON",
                success: function (data)
                {
