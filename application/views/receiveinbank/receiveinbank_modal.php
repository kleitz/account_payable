...
<script type="text/javascript">
    ...
    function edit_data(id)
    {
        ...
        $.ajax({
            url: "<?php echo site_url('receiveinbank/ajax_view/') ?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function (data)
            {                        
                $('[name="receive_bank_id"]').val(data.receive_bank_id);
                $('[name="receive_bank_number"]').val(data.receive_bank_number);
                $('[name="number_disable"]').val(data.receive_bank_number);
                $('[name="receive_bank_date"]').val(data.receive_bank_date);
                $('[name="receive_type"]').val(data.receive_type);
                $('[name="description"]').val(data.description);
                $('[name="amount"]').val(data.amount);
                $('[name="branch_id"]').val(data.branch_id);
                $('[name="outstanding_id"]').val(data.outstanding_id);
    ...
    function save()
    {
        ...
        if (save_method == 'add')
        {
            url = "<?php echo site_url('receiveinbank/receive_bank_add') ?>";
        }
        else
        {
            url = "<?php echo site_url('receiveinbank/receive_bank_update') ?>";
        }
    ...
    function delete_data(id)
    {
        if (confirm('Are you sure delete this data?'))
        {
            ...
            $.ajax({
                url: "<?php echo site_url('receiveinbank/receive_bank_delete') ?>/" + id,
                type: "POST",
                dataType: "JSON",
                success: function (data)
                {
...
<div class="modal fade" id="modal_form_up" role="dialog">
    <div class="modal-dialog">
        ...
        echo form_open_multipart('receiveinbank/do_upload', $attribut); 
        ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body form">
                <div class="form-body">
                <input type="hidden" name="receive_bank_id" value="">
