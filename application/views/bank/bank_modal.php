<script type="text/javascript">
    ...
    function add_data()
    {
        ...
        $('.modal-title').text('Add Bank Account'); // Set Title to Bootstrap modal title
    }
    ...
    function edit_data(id)
    {
        ...
        $.ajax({
            ...
            {                        
                ...
                $('[name="bank_code_disabled"]').val(data.bank_code);
                ...
                $('[name="bank_account_no"]').val(data.bank_account_no);
                $('[name="bank_remark"]').val(data.bank_remark);
                $('[name="bank_status"]').val(data.bank_status);
    ...
    function save()
    {
        ...
        {
            url = "<?php echo site_url('bank/bank_update') ?>";
        }
