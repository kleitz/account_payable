<script type="text/javascript">
    ...
    function edit_data(id)
    {
        ...
        $.ajax({
            url: "<?php echo site_url('trans/trans02_ajax_view/') ?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function (data)
            {
                ...
                $('.modal-title').text('Edit Transaction In'); // Set title to Bootstrap modal title
    ...
    function save()
    {
        ...
        if (save_method == 'add')
        {
            url = "<?php echo site_url('trans/trans02_add') ?>";
        }
        else
        {
            url = "<?php echo site_url('trans/trans02_update') ?>";
        }
    ...
    function delete_data(id)
    {
        if (confirm('Are you sure delete this data?'))
        {
            ...
            $.ajax({
                url: "<?php echo site_url('trans/trans02_delete') ?>/" + id,
                type: "POST",
                dataType: "JSON",
                success: function (data)
                {
