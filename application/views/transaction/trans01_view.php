<div class="col-xs-12">
    <div class="box box-primary">
        <div class="box-header with-border">
            ...
            if ($period_active == 1){
            ?>
            <button class="btn btn-primary btn-sm" onclick="add_data()"><i class="glyphicon glyphicon-plus"></i> New Closing Balance</button>
            <?php
            } else {
            ?>
            <button class="btn btn-default btn-sm disabled"><i class="glyphicon glyphicon-plus"></i> New Closing Balance</button>
            <?php
            }
            ?>
        </div>
