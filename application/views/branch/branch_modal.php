<script type="text/javascript">
    ...
    function edit_data(id)
    {
        ...
        $.ajax({
            url: "<?php echo site_url('branch/ajax_edit/') ?>/" + id,
            type: "GET",
            dataType: "JSON",
    ...
    function save()
    {
        ...
        if (save_method == 'add')
        {
            url = "<?php echo site_url('branch/branch_add') ?>";
        }
        else
        {
            url = "<?php echo site_url('branch/branch_update') ?>";
        }
    ...
    function delete_data(id)
    {
        if (confirm('Are you sure delete this data?'))
        {
            ...
            $.ajax({
                url: "<?php echo site_url('branch/branch_delete') ?>/" + id,
                type: "POST",
                dataType: "JSON",
                success: function (data)
                {
