<div class="col-xs-12">
    <div class="box box-primary">
        <div class="box-header with-border">
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <div class="btn-group">
                        ...
                        <a href="<?php echo site_url('cashreceived/go/'.$pagecode.'/2/') ?>" class="btn btn-default">This Week</a>
                        <a href="<?php echo site_url('cashreceived/go/'.$pagecode.'/3/') ?>" class="btn btn-default">This Month</a>
                        <a href="<?php echo site_url('cashreceived/go/'.$pagecode.'/4/') ?>" class="btn btn-default">Last Month</a>
                    </div>
                </div>  
            </div>
            <?php
            if ($period_active == 1){
            ?>
            <button class="btn btn-primary btn-sm" onclick="add_data()"><i class="glyphicon glyphicon-plus"></i> New Data</button>
            <?php
            } else {
            ?>
            <button class="btn btn-default btn-sm disabled"><i class="glyphicon glyphicon-plus"></i> New Data</button>
            <?php
            }
            ?>
        </div>
