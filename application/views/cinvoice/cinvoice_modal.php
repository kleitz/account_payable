...
<script type="text/javascript">
    ...
    function edit_data(id)
    {
        ...
        $.ajax({
            url: "<?php echo site_url('creditinvoice/ajax_edit/') ?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function (data)
            {
                $('[name="credit_invoice_id"]').val(data.credit_invoice_id);
                $('[name="credit_invoice_number"]').val(data.credit_invoice_number);
                $('[name="credit_invoice_number_disabled"]').val(data.credit_invoice_number);
    ...
    function save()
    {
        ...
        if (save_method == 'add')
        {
            url = "<?php echo site_url('creditinvoice/purchaseorder_add') ?>";
        }
        else
        {
            url = "<?php echo site_url('creditinvoice/purchaseorder_update') ?>";
        }
        ...
        $.ajax({
            ...
            success: function (data)
            {
                ...
                window.location = "<?php echo site_url('creditinvoice/go/'.$pagecode.'/3/') ?>";
            },
            error: function (jqXHR, textStatus, errorThrown)
            {
    ...
    function delete_data(id)
    {
        if (confirm('Are you sure delete this data?'))
        {
            ...
            $.ajax({
                url: "<?php echo site_url('creditinvoice/purchaseorder_delete') ?>/" + id,
                type: "POST",
                dataType: "JSON",
                success: function (data)
                {
...
<div class="modal fade" id="modal_form_up" role="dialog">
    <div class="modal-dialog">
        ...
        echo form_open_multipart('creditinvoice/do_upload', $attribut); 
        ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body form">
                <div class="form-body">
                    <input type="hidden" name="credit_invoice_id" value="">

                    <div class="form-group">
                        <div class="col-md-12">
                        <label class="control-label">File PO</label>
                        <input type="file" name="userfile1" class="filestyle" data-icon="false" data-buttonname="btn-default">
                        </div>
                    </div>
                    
                    <div class="form-group">
                        <div class="col-md-12">
                        <label class="control-label">File Invoice</label>
                        <input type="file" name="userfile2" class="filestyle" data-icon="false" data-buttonname="btn-default">
                        </div>
                    </div>
                    
                    <div class="form-group">
                        <div class="col-md-12">
                        <label class="control-label">File Up Receive</label>
                        <input type="file" name="userfile3" class="filestyle" data-icon="false" data-buttonname="btn-default">
                        </div>
                    </div>
