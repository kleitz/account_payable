...
<script type="text/javascript">
    ...
    {
        var url;
        if (save_method == 'add_remark')
        {
            url = "<?php echo site_url('cashrequest/add_remark_from_modal') ?>";
        }
...
<div class="modal fade" id="modal_remark_form" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" id="btnSave" onclick="save_remark()" class="btn btn-primary">Save</button>
                <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
